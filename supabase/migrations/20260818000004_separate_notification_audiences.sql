-- Separate notification audiences and enrich admin messages.
-- customer_id = null means admin notification; customer_id = auth user id means customer notification.
