...
import { Mail, MailOpen, Phone, RefreshCw } from "lucide-react";
...
function AdminMessages() {
  ...
  const load = async () => { setLoading(true); const { data } = await supabase.from("customer_messages").select("*").order("created_at", { ascending: false }); setMessages(data ?? []); setLoading(false); };
