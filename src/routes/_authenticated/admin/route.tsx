...
function AdminLayout() {
  ...
  const items = [
    ...
    { to: "/admin/packages", label: t("a_packages"), icon: Package },
    { to: "/admin/offers", label: t("a_offers"), icon: Gift },
    { to: "/admin/payments", label: t("a_payments"), icon: BadgeDollarSign },
    { to: "/admin/employees", label: t("a_employees"), icon: UserSquare },
    { to: "/admin/notifications", label: t("a_notifications"), icon: Bell },
    { to: "/admin/reports", label: t("a_reports"), icon: PieChart },
    { to: "/admin/pages", label: t("a_pages"), icon: FileText },
